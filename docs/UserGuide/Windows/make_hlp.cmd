...
@if errorlevel 1 goto failed
@copy           ..\..\GSGuide\windows\content\images\toolbar\function_selector.png    content\common\images\toolbar\selfnc.png
@if errorlevel 1 goto failed
...
@if errorlevel 1 goto failed
@copy           ..\..\GSGuide\windows\content\images\toolbar\selection_off.png        content\common\images\toolbar\seloff.png
@if errorlevel 1 goto failed
@copy           ..\..\GSGuide\windows\content\images\toolbar\selection_on.png         content\common\images\toolbar\selon.png
@if errorlevel 1 goto failed
...
@if errorlevel 1 goto failed
@copy           ..\..\GSGuide\windows\content\images\toolbar\view_control.png         content\common\images\toolbar\view_c.png
@if errorlevel 1 goto failed
@
IF EXIST "%ProgramFiles%\HTML Help Workshop\hhc.exe" (
"%ProgramFiles%\HTML Help Workshop\hhc.exe" firewrkz.hhp
