...
#if RISCOS
#if defined(BOUND_MESSAGES_OBJECT_ID_FL_FWP)
extern PC_U8 rb_fl_fwp_msg_weak;
#define P_BOUND_MESSAGES_OBJECT_ID_FL_FWP &rb_fl_fwp_msg_weak
#else
#define P_BOUND_MESSAGES_OBJECT_ID_FL_FWP DONT_LOAD_MESSAGES_FILE
#endif
#else
#define P_BOUND_MESSAGES_OBJECT_ID_FL_FWP DONT_LOAD_MESSAGES_FILE
#endif

#define P_BOUND_RESOURCES_OBJECT_ID_FL_FWP DONT_LOAD_RESOURCES
...
T5_MSG_PROTO(static, fwp_msg_initclose, _InRef_ PC_MSG_INITCLOSE p_msg_initclose)
{
    ...
    case T5_MSG_IC__STARTUP:
        return(resource_init(OBJECT_ID_FL_FWP, P_BOUND_MESSAGES_OBJECT_ID_FL_FWP, P_BOUND_RESOURCES_OBJECT_ID_FL_FWP));
