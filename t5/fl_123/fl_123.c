...
#if RISCOS
#if defined(BOUND_MESSAGES_OBJECT_ID_FL_LOTUS123)
extern PC_U8 rb_fl_123_msg_weak;
#define P_BOUND_MESSAGES_OBJECT_ID_FL_LOTUS123 &rb_fl_123_msg_weak
#else
#define P_BOUND_MESSAGES_OBJECT_ID_FL_LOTUS123 LOAD_MESSAGES_FILE
#endif
#else
#define P_BOUND_MESSAGES_OBJECT_ID_FL_LOTUS123 DONT_LOAD_MESSAGES_FILE
#endif
...
T5_MSG_PROTO(static, lotus123_msg_initclose, _InRef_ PC_MSG_INITCLOSE p_msg_initclose)
{
    ...
    case T5_MSG_IC__STARTUP:
        return(resource_init(OBJECT_ID_FL_LOTUS123, P_BOUND_MESSAGES_OBJECT_ID_FL_LOTUS123, P_BOUND_RESOURCES_OBJECT_ID_FL_LOTUS123));
